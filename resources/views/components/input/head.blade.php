...
<meta name="csrf-token" content="OpeYMKAdYu4hVcvvvcS0744VqeRokgILb7EQ7e5a">
...
<link rel="apple-touch-icon" sizes="76x76" href="{{asset("https://material-dashboard-laravel.creative-tim.com/material/img/apple-icon.png")}}">
<link rel="icon" type="image/png" href="{{asset("https://material-dashboard-laravel.creative-tim.com/material/img/favicon.png")}}">
...
<link href="{{asset("https://material-dashboard-laravel.creative-tim.com/material/demo/demo.css")}}" rel="stylesheet" />
<!-- Google Tag Manager -->
